    ...
    <header className="top-0 left-0 z-50 w-full bg-secondary md:fixed ">
      <div className="max-w-screen-xl m-auto navbar">
        <div className="navbar-start">
          ...
          <a href="/" className="font-bold text-text">
            Huma
          </a>
          <div className="hidden lg:flex">
            <ul className="px-4 menu menu-horizontal">
              ...
              <li>
                <a
                  href="#"
                  className="px-4 font-bold text-text md:hover:text-secondary"
                >
                  Item 2
                </a>
              </li>
              <li>
                <a
                  href="#"
                  className="px-4 font-bold md:hover:text-secondary text-text"
                >
                  Item 3
                </a>
              </li>
          ...
          <div>
            <button type="submit">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 17 17"
                className="object-contain w-4 h-4 fill-current"
              >
        ...
        <div className="navbar-end">
          <a href="/login" className="font-bold text-text">
            Login
          </a>
